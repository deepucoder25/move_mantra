<!-- HERO SLIDER SECTION FOR CITY PAGE -->
<section class="home-page-slider position-relative py-5" itemscope itemtype="https://schema.org/WPHeader">
  <div class="container position-relative z-2">
      ...
      <div class="col-12">
        <nav class="bc-nav pm-city-slider-nav">
          ...
          <span class="bc-sep">›</span>
            ...
            <a href="<?= site_url($state_slug) ?>" class="bc"><?= $state ?></a>
          <span class="bc-sep">›</span>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-xl-6 col-lg-7 col-md-10 text-start hero-text-col">
        ...
        <h1 class="hero-title fw-extrabold mb-3 text-dark-navy" itemprop="name">
          Best Packers and Movers in <span class="accent-text text-secondry"><?= $city ?></span>
        </h1>

        <!-- Subtext Description -->
        <p class="hero-lead text-secondary fs-6 mb-4 max-w-500" itemprop="description">
          Best movers &amp; packers in <?= $city ?>, <?= $state ?>. Safe, affordable, and reliable packing, moving and storage services. Get your free quote now.
        </p>
        ...
        <div class="google-rating-badge d-inline-flex align-items-center gap-2 px-3 py-2 rounded-pill bg-white shadow-sm border mt-1 mb-2">
          ...
          <span class="fw-extrabold text-dark-navy fs-6 me-1"><?= !empty($ratingValue) ? $ratingValue : '4.9' ?>/5</span>
          ...
          <span class="extra-small text-muted fw-semibold ms-1"><?= !empty($ratingCount) ? $ratingCount : '1600' ?>+ Reviews</span>
        </div>
      </div>
    ...
    <div class="hero-bottom-stats-card bg-white p-3 p-md-4 mt-2">
      <div class="row row-cols-lg-5 row-cols-md-3 row-cols-2 align-items-center text-center text-md-start">
        <!-- Stat 1 -->
        <div class="col border-end-md">
          <div class="d-flex align-items-center gap-3 px-2">
            ...
            <div>
              <h4 class="fw-bold text-dark-navy mb-0 fs-3 lh-1"><?= !empty($yearsExperience) ? $yearsExperience : '10+' ?></h4>
        ...
        <div class="col border-end-md">
          <div class="d-flex align-items-center gap-3 px-2">
            ...
            <div>
              <h4 class="fw-bold text-dark-navy mb-0 fs-3 lh-1"><?= !empty($happyClients) ? $happyClients : '25K+' ?></h4>
        ...
        <div class="col border-end-md">
          <div class="d-flex align-items-center gap-3 px-2">
            ...
            <div>
              <h4 class="fw-bold text-dark-navy mb-0 fs-3 lh-1"><?= !empty($citiesCovered) ? $citiesCovered : '500+' ?></h4>
        ...
        <div class="col border-end-md">
          <div class="d-flex align-items-center gap-3 px-2">
            ...
            <div>
              <h4 class="fw-bold text-dark-navy mb-0 fs-3 lh-1"><?= !empty($satisfactionRate) ? $satisfactionRate : '99%' ?></h4>
